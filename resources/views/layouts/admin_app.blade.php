    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="area">
             ...
             <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#desig" aria-expanded="false" aria-controls="icons">
              <i class="typcn typcn-user-outline menu-icon"></i>
              <span class="menu-title">Manage Designation</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="desig">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('show_designation')}}">Designation</a></li>
              </ul>
            </div>
          </li>
          <!--<li class="nav-item">-->
          ...
          <!--      <li class="nav-item"><a class="nav-link" href="#">Paper tion </a></li>-->
