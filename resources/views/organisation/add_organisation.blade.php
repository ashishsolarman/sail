...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card-header" style="text-align: center; padding-bottom: 3%; font-size: 26px; color: #000000">Add Organisation</div>
                <form action="{{route('add_organisation')}}" method="post" enctype="multipart/form-data" >
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" value="{{old('short_name')}}"  name="state" id="state">
                       @error('state')
                                  <span style="color:red;">{{$message}}</span>
                                @enderror
                     </div>
  ...
  <div class="form-group col-md-12">
                      ...
                      <textarea id="description" class="form-control" name="description" rows="6" cols="50"></textarea>
                       @error('description')
                                  <span style="color:red;">{{$message}}</span>
                                @enderror
                     </div>
